 ...
 /* *************************************************** */
  ...
  const handleShowModal = () => setShowModal(true);
   ...
   const cargarDatos = async ()=>{
    ...
    const elQueryb ={"myQuery":`select * from pfvet_adjuntos where trim(originador) = '${array[0]}' and id_originador=${array[1]} ;`};
...
//4 - renderizamos la datatable
        return (
         ...
         <>
          <> 
          <p>-- GESTION DE ADJUNTOS  --</p>
          <button className='btn btn-info btn-sm'
				onClick={cargarDatos}>REFRESCAR LISTA </button>
